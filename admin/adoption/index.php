...
<div class="wrapper">
    ...
    <?php
      if(isset($_POST['reject']))
      {
        ...
        $str="UPDATE pets SET status='available' WHERE pet_id=(SELECT pet_id FROM adoptionrequests WHERE request_id=$request_id)";
        mysqli_query($conn,$str);
  ...
  <div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Pets Adoption Requests</h1>
          </div>
        </div>
      </div>
            ...
            <!-- Pet Details -->
             <div class="card-body table-responsive" >
                ...
                <?php
                    ...
                    WHERE adoptionrequests.status='pending'";
                    $result = mysqli_query($conn, $str);
                    if(mysqli_num_rows($result) <= 0) {
                      echo "<tr><td colspan='8' class='text-center'>No pending adoption requests found.</td></tr>";
                    }
