      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-11 ftco-animate text-center">
            ...
            <p><a href="pet.php" class="btn btn-primary mr-md-4 py-3 px-4">Find a pet to adopt <span class="ion-ios-arrow-forward"></span></a></p>
          </div>
        </div>
      </div>
    </div>
	            ...
	            <h2 class="mb-4">Why Choose Us?</h2>
    				...
    				<div class="row">
	    				<div class="col-md-6 services-2 w-100 d-flex">
	    					...
	    					<div class="text pl-3">
	    						<h4>Care Advices</h4>
	    						<p>Schedule routine vet visits to keep your pet healthy and happy.</p>
	    					</div>
	    				</div>
	    				<div class="col-md-6 services-2 w-100 d-flex">
	    					...
	    					<div class="text pl-3">
	    						...
	    						<p>Need help or have a question? Our customer support team is dedicated to assisting you and your pets—quickly and professionally.</p>
	    					</div>
	    				</div>
	    				<div class="col-md-6 services-2 w-100 d-flex">
	    					...
	    					<div class="text pl-3">
	    						...
	    						<p>In an emergency, every second counts. If a pet is injured, bleeding heavily, has trouble breathing, contact a veterinarian immediately.</p>
	    					</div>
	    				</div>
	    				<div class="col-md-6 services-2 w-100 d-flex">
	    					...
	    					<div class="text pl-3">
	    						...
	    						<p>Our veterinary services are here to support your pet’s health and well-being every step of the way.</p>
	    					</div>
	    				</div>
	    			</div>
	        </div>
