  ...
  <body>
	...
	<?php
		...
		if(isset($_POST['submit'])){
			...
			// Here you can add code to send the email or save the data to the database
					...
					<div class="col-md-12">
						<div class="wrapper">
							<div class="row mb-5">
				        		...
				        		<div class="text">
					            <p><span>Address:</span> C.B.Patel College </p>
					          </div>
				          </div>
								</div>
								<div class="col-md-3">
				        		...
				        		<div class="text">
					            <p><span>Phone:</span> <a href="tel://1234567920">+91 12352 35598</a></p>
					          </div>
				          </div>
								</div>
								<div class="col-md-3">
				        		...
				        		<div class="text">
					            <p><span>Email:</span> <a href="mailto:info@petconnect.com">info@petconnect.com</a></p>
					          </div>
				          </div>
								</div>
								<div class="col-md-3">
				        		...
				        		<div class="text">
					            <p><span>Website</span> <a href="index.php">PetConnect.com</a></p>
					          </div>
				          </div>
								</div>
							</div>
											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														...
														<input type="text" class="form-control" <?php if(isset($_SESSION['uname'])){ echo "readonly"; } ?> value="<?php if(isset($_SESSION['uname'])){ echo $user_data['name']; } ?>" name="name" id="name" placeholder="Name">
													</div>
												</div>
												<div class="col-md-6"> 
													<div class="form-group">
														<label class="label" for="email">Email Address</label>
														<input type="email" <?php if(isset($_SESSION['uname'])){ echo "readonly"; } ?> class="form-control" value="<?php if(isset($_SESSION['uname'])){ echo $_SESSION['uname']; } ?>" name="email" id="email" placeholder="Email">
													</div>
												</div>
												<div class="col-md-12">
													<div class="form-group">
